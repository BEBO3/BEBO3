...
+~~Developer By : @T_1S1_T On Telegram ,
...
git clone https://github.com/BEBO3/BEBO3.git
...
libpython-dev expat libexpat1-dev -y && cd $HOME && rm -rf BEBO3 && rm -rf .telegram-cli && git clone https://github.com/BEBO3/BEBO3.git && cd BEBO3 && ./launch.sh install && ./launch.sh
~~~~~
